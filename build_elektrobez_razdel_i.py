...
def build():
    ...
    w0["A2"] = (
        "Банк вопросов 2026 (файл «приложение 2_sent»). "
        "Правильный ответ в типовой компоновке Приложения 2 — первый вариант. "
        "Знаки «+» в исходнике — область применения (напряжение и группа II–V), не ключ."
    )
