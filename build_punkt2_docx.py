...
# Система 2. РИС-н параллельно. На экране те же две строки τ = 0 и 0,5.
CSTR_PAR = [(0.0, 0.0000, 0.0000, 0.0000), (0.5, 0.5454, 0.3030, 0.2424)]
...
def build():
    ...
    pfr_par = [(0.0, 0.0000, 0.0000, 0.0000), (0.5, 0.6988, 0.4444, 0.2544)]
    ...
    add_p(
        ...
        "На экране у каждого реактора две строки: τ = 0 (вход) и τ = 0,5 мин (выход). "
    ...
    add_p(doc, "Vi = 25 л. На экране две строки: τ = 0 и τ = 0,5 мин. Все четыре аппарата одинаковы.", size=12)
    for i in range(1, 5):
        add_p(doc, f"Реактор {i}", size=13, bold=True, color=(46, 117, 182), space_before=4, space_after=4)
